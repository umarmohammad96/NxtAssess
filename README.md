...
You will demonstrate your skills by creating an app that will fetch data from an internal server using a functional component, displaying that data, using React hooks, routing concepts, authentication, and authorization, and adding responsiveness to the website.
...
- You can check the **Design Files** for different devices <a href="https://www.figma.com/file/9v8qt3eNxyBQrqYBfoaUVJ/NXT-Assess" target="_blank">here</a>.
...
- **Login Route**
  ...
  - When an unauthenticated user tries to access the Home Route, Assessment Route and Results Route, then the page should be navigated to Login Route
  - When an authenticated user tries to access the Home Route, Assessment Route and Results Route, then the page should be navigated to the respective route
  ...
  - When an authenticated user opens the Assessment Route,
    ...
    - An HTTP GET request should be made to **questionsApiUrl**
      ...
      - After the data is fetched successfully,
        - First question text and its corresponding options from the list of questions received from the response should be displayed
    ...
    - If the active question the `option_type` value is either `DEFAULT` or `IMAGE` and an option is selected,
    ...
    - If the active question the `option_type` value is `SINGLE_SELECT`
...
- **Results Route**
  ...
  - When the **Submit Assessment** button in the Assessment Route is clicked within the time, then the submitted view should be displayed as shown in the Figma
...
Use the following files to implement the **Nxt Assess App**
...
- `src/components/Assessment/index.css`
- `src/components/AssessmentConfiguration/index.jsx`
- `src/components/AssessmentConfiguration/index.css`
- `src/components/Timer/index.jsx`
- `src/components/Timer/index.css`
- `src/components/QuestionPalette/index.jsx`
- `src/components/QuestionPalette/index.css`
- `src/components/QuestionNumberItem/index.jsx`
- `src/components/QuestionNumberItem/index.css`
- `src/components/Question/index.jsx`
- `src/components/Question/index.css`
- `src/components/ButtonOptionItem/index.jsx`
- `src/components/ButtonOptionItem/index.css`
- `src/components/ImageOptionItem/index.jsx`
- `src/components/ImageOptionItem/index.css`
